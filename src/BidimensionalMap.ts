...
export interface BidimensionalMap<K extends Keys<any>, V> {
  get(keys: K): V | undefined;
  set(keys: K, value: V): void;
  has(keys: K): boolean;
  delete(keys: K): void;
  // cleanup(): void;
  // forEach(callbackfn: (keys: K, value: V) => void): void;
}
...
export function createBidimensionalMap<
  K extends Keys<any>,
  V
>(): BidimensionalMap<K, V> {
